...
def getContours(img,cThr = [100,100],showCanny = False,minArea = 10,filter = 0,draw = False):
    ...
    if lines is not None:
        ...
        # print("1 point - ",int(point1),int(point2),int(point3),int(point4))
        print("bottom-left point x - ", int(point1[0])," y - ", int(point1[1]))
        print("bottom-right point x - ", int(point2[0])," y - ", int(point2[1]))
        print("top-left point x - ", int(point3[0])," y - ", int(point3[1]))
        print("top-right point x - ", int(point4[0])," y - ", int(point4[1]))
    return img